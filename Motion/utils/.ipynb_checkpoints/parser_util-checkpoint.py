...
def add_base_options(parser):
    ...
    group.add_argument("--goal", default=(6,6), nargs=2, type=float, help="For set the goals.")
    group.add_argument("--radius", default=1, type=float, help="The radius of the obstacle.")
    group.add_argument("--method", default='PGD', type=str, help="The adopted method (FreeDoM or DPS or PGD).")
    group.add_argument("--rho", default=1, type=float, help="The step size for guidance.")
